...
public class Order {
	...
	public Order(MyDate d, double amt, String c, Product p, int q){
		try {
			...
			System.out.println("The order date for an order cannot be a holiday! Appication is closing.");
			System.exit(0);
		}
		orderAmount = amt;
		customer = c;
	...
	public char jobSize() {
		...
		else if (quantity < 25 && quantity < 76) {
			return 'M';
		}
		else if (quantity < 75 && quantity < 151) {
			return 'L';
		}
		else {
			return 'X';
